...
from hash.constants import rotate_by
...
init_MDBuffer: List[int] = [0x67452301, 0xEFCDAB89, 0x98BADCFE, 0x10325476]
...
def processMessage(msg: bytearray) -> int:
